...
import com.websecurity.exception.BadRequestException;
import com.websecurity.exception.ResourceNotFoundException;
import com.websecurity.model.*;
import com.websecurity.payload.PagedResponse;
import com.websecurity.payload.PollRequest;
import com.websecurity.payload.PollResponse;
import com.websecurity.payload.VoteRequest;
...
import com.websecurity.util.ModelMapper;
...
public class PollService {
    ...
    public PollResponse castVoteAndGetUpdate(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser){
        ...
        Choice selectChoice = poll.getChoices().stream()
...
//                .map(Poll::getCreatedAt)
//                .distinct()
//                .collect(Collectors.toList());
//
//        List<User> creators = userRepository.findByIdIn(creatorIds);
//        Map<Long, User> creatorsMap = creators.stream()
